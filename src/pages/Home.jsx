  ...
  return (
    <>
      ...
      <section
        ...
        className="hero-section relative w-full min-h-screen bg-no-repeat bg-cover max-md:bg-right-center"
      >
        {/* bg video */}
        <div
          className="w-full bg-black max-h-screen absolute z-1 top-0 left-0 h-full object-fit"
        >
          <video
            width={"100%"}
            height={"100%"}
            className="w-full h-full max-h-screen object-cover md:object-right-bottom"
            autoPlay={true}
            muted={true}
            loop
          >
        ...
        <div className="w-full sticky z-2 text-left flex flex-col gap-3 px-10 min-md:pl-[10vw] py-10 min-h-[50vh] place-content-center">
          <TextAnimToTop>
          <h1 className="text-3xl md:text-5xl font-semibold min-md:text-nowrap break-word">
            Engineering Your Edge{" "}
            <sup className="font-extrabold text-[20px] md:text-[15px] top-[-15px]">
              TM
            </sup>
          </h1>
          </TextAnimToTop>
          <p className="text-md max-w-[370px] tracking-widest leading-6.5">
      ...
      <section className="p-5 w-full my-10">
        <div className="max-w-[900px] m-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 max-md:text-center">
            <h2 className="text-5xl font-bold font-sans max-md:p-5">
              Industries
            </h2>
      ...
      <section className="px-10 py-15 w-full my-10 bg-black sticky top-0 z-0">
        <div className="rounded-tl-xl rounded-bl-xl max-md:rounded-tr-3xl max-md:rounded-bl-3xl max-md:rounded-tl-none overflow-hidden w-full flex max-md:flex-col justify-center align-middle gap-0">
          <div className="bg-[#d8d8d8] aspect-[5/4] max-md:aspect-auto w-1/2 max-md:w-full p-6 flex flex-col justify-center align-middle gap-2">
            <h4 className="text-3xl font-bold">"Bold Ideas. Real Impact."</h4>
            <p className="tex-md font-light height-">
              We don’t just talk about change — we engineer it. A N V I
              Foundation turns bold visions into programs that touch lives, lift
              communities, and rewrite stories of hope.
            </p>
          </div>
          <img
            className="w-full min-md:max-w-1/2 max-md:w-screen md:w-full aspect-[5/4] max-md:aspect-video object-cover object-center"
            src="https://media.gettyimages.com/id/1488640232/photo/engineering-tablet-and-people-in-automation-lab-with-machine-for-analysis-research-and.jpg?s=612x612&w=0&k=20&c=0sq5Av7w-ffMcxIFuJvnukp7d1cwyl86bGO6PV6kgNI="
            alt="engineering"
          />
        </div>
      </section>
