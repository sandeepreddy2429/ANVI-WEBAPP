  ...
  return (
    <section className="w-full h-screen  flex items-center justify-center bg-[#f4f4f4] py-16 px-16 text-center">
      <div className="max-w-7xl mb-10">
        ...
        <p className="text-md sm:text-xl md-text-xl text-gray-800 sm:px-4 md:px-16">
          This page isn't available. Please click the button to return to the
          homepage.
        </p>
        <Link
          to="/"
          style={{ color: "#fff" }}
          className="inline-block mt-10 p-2 bg-black py-3 px-5 rounded-md hover:bg-[#22a0afb3] hover:text-white transition-colors duration-200"
        >
          Go to HomePage
        </Link>
      </div>
